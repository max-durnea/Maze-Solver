...
def main():
    ...
    # Generate the maze
    maze = Maze(margin, margin, num_rows, num_cols, cell_size_x, cell_size_y, win, seed, speed=0.05)  # Adjusted speed for smoother animation
    ...
    maze = Maze(margin, margin, num_rows, num_cols, cell_size_x, cell_size_y, win, seed,speed = 0.05)  # Recreate the maze
    maze.reset_cells_visited()  # Reset visited status for all cells
